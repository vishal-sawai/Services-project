                ...
                <div id="content">
                    ...
                    <div class="card shadow mb-4">
                        <div class="card-header py-3">
                            <h6 class="m-0 font-weight-bold text-primary">Enquire Data</h6>
                        </div>
                        <div class="card-body">
                                    ...
                                    <tbody>
                                        ...
                                        ?>
                                            <tr>
                                                ...
                                                <td><?php echo $row["projectinfo"] ?></td>
                                                <td><?php echo $row["datetime"] ?></td>
                                                <td><a class="btn btn-danger fw-bold" href="deletedata.php?id=<?php echo $row['id']; ?>&amp;table=<?php echo 'enquire' ?>">Delete</a></td>
