            ...
            <ul class="navbar-nav bg-gradient-primary sidebar sidebar-dark accordion" id="accordionSidebar">
                ...
                <li class="nav-item">
                    <a class="nav-link" href="message.php">
                        <i class="fas fa-regular fa-comment-dots"></i> <span>Message</span></a>
                </li>
                <!-- Nav Item - Subcribe -->
                <li class="nav-item">
                    <a class="nav-link" href="mailsubcribe.php">
                        <i class="fas fa-solid fa-envelope"></i>
                        <span>Mail Subcribe</span></a>
                </li>
                ...
                <div id="content">
                        ...
                        <ul class="navbar-nav ml-auto">
                            ...
                            <li class="nav-item dropdown no-arrow">
                                <a class="nav-link dropdown-toggle" href="#" id="userDropdown" role="button" data-toggle="dropdown" aria-haspopup="true" aria-expanded="false">
                                    <span class="mr-2 d-none d-lg-inline text-gray-600 small"><?php echo $_SESSION['adminUser'];
                                                                                                ?></span>
                    ...
                    <div class="container-fluid">
                        ...
                        <div class="row">
                                        ...
                                        <div class="row no-gutters align-items-center">
                                            <div class="col mr-2">
                                                <div class="text-xs font-weight-bold text-primary text-uppercase mb-1">
                                                    Enquire </div>
                                                <div class="h5 mb-0 font-weight-bold text-gray-800"><?php echo " $count_enquire" ?></div>
                                            </div>
                                            <div class="col-auto">
                                                <i class="fas fa-solid fa-envelope-open-text fa-2x text-gray-300"></i>
                                            </div>
                                        </div>
                                    </div>
                                </div>
                                ...
                                <div class="card border-left-success shadow h-100 py-2">
                                    <div class="card-body">
                                        <div class="row no-gutters align-items-center">
                                            ...
                                            <div class="col-auto">
                                                <i class="fas fa-regular fa-comment-dots fa-2x text-gray-300"></i>
                                            </div>
                                        </div>
                                    </div>
                                </div>
                            ...
                            <!-- Mail Subscription Card Example -->
                            <div class="col-xl-4 col-md-6 mb-4">
                                    ...
                                    <div class="card-body">
                                        <div class="row no-gutters align-items-center">
                                            <div class="col mr-2">
                                                ...
                                                <div class="h5 mb-0 font-weight-bold text-gray-800"><?php echo " $count_mail" ?></div>
                                            </div>
                                            <div class="col-auto">
        ...
        <div class="modal fade" id="logoutModal" tabindex="-1" role="dialog" aria-labelledby="exampleModalLabel" aria-hidden="true">
            <div class="modal-dialog" role="document">
                <div class="modal-content">
                    ...
                    <div class="modal-body">Are you want to logout</div>
