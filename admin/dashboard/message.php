                ...
                <div id="content">
                    ...
                    <div class="card shadow mb-4">
                        <div class="card-header py-3">
                            <h6 class="m-0 font-weight-bold text-primary">Contatct Data</h6>
                        </div>
                        <div class="card-body">
                                    ...
                                    <tbody>
                                        ...
                                        ?>
                                            <tr>
                                                ...
                                                <td><a class="btn btn-danger fw-bold" href="deletedata.php?id=<?php echo $row['id']; ?>&amp;table=<?php echo 'message' ?>">Delete</a></td>
